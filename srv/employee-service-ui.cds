...
[
    ...
    { $Type : 'UI.DataField', Value : skill.institution, Label : 'Institution' },
    { $Type : 'UI.DataField', Value : skill.type, Label : 'Type' },
    { $Type : 'UI.DataField', Value : dateAcquired, Label : 'Date Acquired' },
    { $Type : 'UI.DataField', Value : comfortLevel,  Label : 'Comfort Level' },
    { $Type : 'UI.DataField', Value : renewal, Label : 'Renewal Status'},
    { $Type : 'UI.DataField', Value : renewal, Label : 'Renewal Status'},
 ],
    UI.HeaderInfo: {
			TypeName: 'Skill',
